...
function __swapSel_buildCode()
{
  ...
  // Create main div
  obj_clean = document.createElement('div');
  obj_attribute = document.createAttribute("style");
  obj_attribute.nodeValue = 'clear:left';
  obj_clean.setAttributeNode(obj_attribute);
  ...
  obj_parentNode = document.getElementById(this.id + '_tmp').previousSibling;//parentNode;
  
  // Add swap select element to parent element
  obj_parentNode.appendChild(obj_swapSel);
  obj_parentNode.appendChild(obj_clean);
